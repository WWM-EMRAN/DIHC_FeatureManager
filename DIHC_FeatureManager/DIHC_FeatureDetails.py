...
class DIHC_FeatureDetails:
    ...
    td_nonlinear_entropy = ['approximateEntropy', 'sampleEntropy', 'permutationEntropy', 'spectralEntropy',
                            'singularValueDecompositionEntropy', 'fuzzyEntropy', 'distributionEntropy', 'shannonEntropy',
                            'renyiEntropy']
    td_nonlinear_entropy_short = ['appEn', 'sampEn', 'permEn', 'specEn', 'svdEn', 'fuzzEn', 'distEn', 'shanEn',
                                  'renEn']
    td_nonlinear_entropy_short2 = ['ApEn', 'SampEn', 'PermEn', 'SpecEn', 'SVDEn', 'FuzzEn', 'DistEn', 'ShanEn',
                                  'RenEn']
    ...
    def __init__(self):
        ...
        self.all_features_short = self.td_linear_statistical_short + self.td_nonlinear_entropy_short +\
                                  ...
                                  self.fd_linear_statistical_binwise_short + self.fd_spectral_band_power_short
        self.all_features_short2 = self.td_linear_statistical_short2 + self.td_nonlinear_entropy_short2 +\
                                  ...
                                  self.fd_linear_statistical_binwise_short2 + self.fd_spectral_band_power_short2
        return
